...
public class Parser : MonoBehaviour {
    ...
    public void ParseFiles()
    {
        ...
        string[] elems = elem.text.Split(new string[] { " ", "\n", "\r" }, StringSplitOptions.RemoveEmptyEntries);//la relación de tetraedros
        string[] nodes = node.text.Split(new string[] { " ", "\n", "\r" }, StringSplitOptions.RemoveEmptyEntries);//con la relación de nodos de la malla de tetraedros
